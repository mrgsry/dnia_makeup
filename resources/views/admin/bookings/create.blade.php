                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control @error('package') is-invalid @enderror" name="package" id="package">
                            ...
                            <option value="mini" data-price="15000000" {{ old('package')=='mini' ? 'selected' : '' }}>Paket Dnia Wedding Mini: Rp. 15,000,000</option>
                            <option value="silver" data-price="20000000" {{ old('package')=='silver' ? 'selected' : '' }}>Paket Dnia Wedding Silver: Rp. 20,000,000</option>
                            <option value="vip" data-price="23500000" {{ old('package')=='vip' ? 'selected' : '' }}>Paket Dnia Wedding VIP: Rp. 23,500,000</option>
                            <option value="diamond" data-price="26500000" {{ old('package')=='diamond' ? 'selected' : '' }}>Paket Dnia Wedding Diamond: Rp. 26,500,000</option>
                            <option value="aula" data-price="29800000" {{ old('package')=='aula' ? 'selected' : '' }}>Paket Dnia Wedding Aula: Rp. 29,800,000</option>
                            <option value="glamour" data-price="33500000" {{ old('package')=='glamour' ? 'selected' : '' }}>Paket Dnia Wedding Glamour: Rp. 33,500,000</option>
                        </select>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (packageSelect) {
            ...
            // auto-fill on load if old('package') selected
